...
public class SimplifyPath {
	...
	/*
	 * 5 situations:
	 * 1. If elem is empty string, then it means we either meet multiple slashes("//", "///"...)
	 ...
	 * 3. If elem is ".."  and stack is not empty, then we have to go back to parent directory.
	 *    For this case, simply pop the top element from the stack;
	 * 4. If elem has a name ("home", "desktop"..) push it to stack.
