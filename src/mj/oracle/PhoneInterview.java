...
class PhoneInterview {
    public static void main(String[] args) {
        ...
        // Call a class method that will take a array of objects,
        // and produce a map that maps keys to values where the keys and values
        // are stored in the array in pairs.   0-> key 1-> value, 2->key, 3->value, etc.
        ...
        // Start the server
        // post 3 requests.
        // request payload is a string like "hello"
        // response payload is a string with extra text like "hello world".
