...
public class ShortestUnsortedContinuousSubarray {
	...
	/*
	 * start & end to keep track of minimum subarray A[start...end], which must be sorted for the entire leetcode.array A to be
	 * sorted. If end < start < 0 at the end of the for loop, then the leetcode.array is already fully sorted.
	 */
