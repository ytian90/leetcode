...
public class SortArrayGivenOrder {
	...
	/*
	Given two arrays，one is actual numbers, the other is position leetcode.array,
	Based on position leetcode.array, leetcode.sort actual number leetcode.array.
	Example：
	actual number leetcode.array : [4 2 1 5 3]
	position leetcode.array : [3 1 0 4 2]
	=>
	actual number leetcode.array [1 2 3 4 5]
	*/
