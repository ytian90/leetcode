...
/**
 * Search Increasing and Decreasing Array
 * @author yutian
 * @since Dec 19, 2015
 */
public class SearchIncrDecrArray {
	...
	public static int search(int[] arr, int target) {
		...
		System.out.println("Search increasing leetcode.array: " + result);
		return (result != -1) ? result : binarySearch(arr, peak, arr.length - 1, target ,false);
	}
