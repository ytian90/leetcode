...
public class DeleteAndEarn {
	/**
	 * If we leetcode.sort all the numbers into buckets indexed by these numbers, this is essentially asking you to repetitively take an bucket while giving incr the 2 buckets next to it. (the range of these numbers is [1, 10000])
