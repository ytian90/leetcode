...
/**
 Question:
 第二道是新题，给multidimensional leetcode.array，给一个function， 输入这个array以及各个dimension上的index，可以output这个位置上的数字。
 写一个function，input是multidimensional leetcode.array，以及array的dimensions，只能调用上面给的那个function，输出这个array里面所有的数字的和。
 ...
 给一个MultiDimArray interface, 然后给一个MultiDimArray和一个Dim leetcode.array，求MultiDimArray 的sum。Dim array表示每个dimension有多少个element。中规中矩，换了个马甲就没写出来，服了自己。.1point3acres网
