...
/**
 * Given two arrays of strings, one containing the prefixes (area code) and one with a long leetcode.string of numbers
 ...
 * Note: Keep in mind that Phone Numbers leetcode.array can be very long
 *
...
public class PrefixNumbers {
    ...
    // Insert a word into the leetcode.trie
    ...
    // Return if the word is in the leetcode.trie.
