...
public class KthLargestElementInAnArray {
	...
	// Sort the entire input leetcode.array and then access the element by its index
	...
	static int quickSelect(int[] a, int lo, int hi, int target) {
	    // use quick leetcode.sort's idea
	    ...
	    // leetcode.sort the nums that are <= pivot from lo
	    int m = i - lo + 1;
