...
public class RecoverBinarySearchTree {
	...
	public static void main(String[] args) {
		...
		leetcode.binaryTree.TreeNode node1 = new leetcode.binaryTree.TreeNode(3);
		node1.left = new leetcode.binaryTree.TreeNode(1);
		node1.right = new leetcode.binaryTree.TreeNode(4);
		node1.right.left = new leetcode.binaryTree.TreeNode(2);
	...
	// method 1 : add in leetcode.stack, check reverse sequence points and swap
