...
public class RotateArray {
	...
	public static void rotate(int[] nums, int k) {
        ...
        rotate(nums, 0, n - k - 1); // reverse one half of the array
        rotate(nums, n - k, n - 1); // reverse other half of the array
        rotate(nums, 0, n - 1); // reverse whole array
    }
	
	public void rotate0(int[] nums, int k) {
        int n = nums.length;
        k %= n;
        rotate(nums, 0, n - 1); // rotate the whole array
        rotate(nums, 0, k - 1); // rotate the first half of array
        rotate(nums, k, n - 1); // rotate the second half of array
    }
